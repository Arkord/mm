    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Menú')" class="grid">
                ...
                @if (auth()->user()?->isAdmin())
                    <flux:navlist.item icon="currency-dollar" :href="route('cash.index')"
                        :current="request()->routeIs('cash.index')" wire:navigate>{{ __('Caja') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="building-office" :href="route('companies.index')"
                        :current="request()->routeIs('companies.index')" wire:navigate>{{ __('Empresas') }}
                    </flux:navlist.item>
