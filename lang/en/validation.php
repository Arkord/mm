...
return [
    ...
    | usados por la clase validadora de Laravel. Algunas de estas reglas tienen
    | múltiples versiones como las reglas de tamaño. Puedes modificarlas aquí.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparece en una filtración de datos. Por favor elige otro diferente.',
    ],
    ...
    | usando la convención "atributo.regla". Esto te permite establecer rápidamente
    | un mensaje específico para una regla en particular de un campo.
    |
    */
    ...
    | de atributos por algo más legible, como "Correo electrónico"
    | en lugar de "email". Esto nos ayuda a hacer los mensajes más claros.
    |
    */
